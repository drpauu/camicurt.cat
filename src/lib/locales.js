...
export const caStandard = {
  ...
  "dailyLevelError": "No s'ha pogut carregar el nivell diari. Torna-ho a provar.",
  "dailyLevelMissing": "No hi ha cap nivell diari publicat per a {date}. Revisa calendar_daily.",
  "dailyLevelRetry": "Reintenta el nivell diari",
  "playToday": "Jugar al problema d'avui",
  "calendar": "Calendari",
  "calendarLoading": "Carregant calendari...",
  "calendarEmpty": "Sense nivells",
  "calendarError": "No s'han pogut carregar els nivells diaris. Torna-ho a provar.",
  "calendarPartial": "El calendari no esta complet. Torna-ho a provar.",
  "calendarRetry": "Reintenta",
  ...
  "tutorial": "Tutorial",
  "tutorialSkip": "Saltar",
  "tutorialStart": "Comença",
  "tutorialProgress": "Progrés del tutorial",
  "tutorialGoToStep": "Anar al pas {value}",
